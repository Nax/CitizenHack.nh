 ...
 */
    ...
    MON("purple dragon", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_MAGENTA, PURPLE_DRAGON),
#if 0 /* DEFERRED */
    ...
    MON("arch-shopkeeper", S_HUMAN, LVL(50, 20, 0, 50, 0), (G_NOGEN | G_UNIQ),
        ...
        | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 30, HI_LORD, ARCH_SHOPKEEPER),
    MON("blacksmith", S_HUMAN, LVL(50, 20, 0, 50, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 8, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SMITH, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
        | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 30, HI_LORD, BLACKSMITH),
