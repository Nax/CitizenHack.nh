...
SHIELD("gold shield", None,
       1, 0, 1,          0, 0, 0, 120, 200, 8, 0, GOLD, HI_GOLD),
...
CONTAINER("bag of holding", "bag", 0, 1, 0, 15,  15, 100, CLOTH, HI_CLOTH),
CONTAINER("bag of fortune", "bag", 0, 1, 0, 15,  15, 100, CLOTH, HI_CLOTH),
...
SCROLL("identify",                  "KERNOD WEL",  1, 175,  20),
SCROLL("magic mapping",              "ELAM EBOW",  1,  40, 100),
...
SCROLL("upgrade",                  "ZAND ANTHEN",  1,  15, 300),
