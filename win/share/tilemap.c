...
const char *tilesrc_texts[] = {
    "monsters.txt", "objects.txt", "artifacts.txt", "other.txt", "generated",
};
...
struct conditionals_t {
    ...
    { OBJ_GLYPH, PURPLE_DRAGON_SCALE_MAIL, "shimmering dragon scale mail" },
    { OBJ_GLYPH, PURPLE_DRAGON_SCALES, "shimmering dragon scales" },
